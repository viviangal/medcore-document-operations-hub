...
//
// Client-side counterpart of server/normalizeDocument.js: in direct mode
// (GitHub Pages) the browser calls n8n directly with no Express proxy in
// between, so this same translation has to happen here instead. Proxy/local
// mode never calls this -- Express already normalizes the response before
// the browser sees it (server/normalizeDocument.js).
